                ...
                <div class="container-fluid">
                    <div class="col-lg-12">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php foreach( $breturns as $breturn )
                                {
                                ?>
                                <tr>
                                    <td><?php echo $breturn->returnid ?></td>
                                    <td><?php echo $breturn->loanid ?></td>
                                    <td><?php echo $breturn->fineid ?></td>
                                    <td><?php echo $breturn->loan_date ?></td>
                                    <td><?php echo $breturn->return_date ?></td>
                                </tr>
                                <?php
                                }
                                ?>
